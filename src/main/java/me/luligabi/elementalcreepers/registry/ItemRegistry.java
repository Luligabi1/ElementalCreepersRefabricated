...
public class ItemRegistry {
    ...
    public static final Item WATER_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item FIRE_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item EARTH_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item AIR_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item ELECTRIC_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item LIGHT_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item DARK_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item ICE_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item MAGMA_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item HYDROGEN_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item REVERSE_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item MINER_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item ILLUSION_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item FIREWORK_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));

    public static final Item COOKIE_GUNPOWDER = new Item(new FabricItemSettings().group(ElementalCreepers.CATEGORY));
