...
public class ReverseTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public ReverseTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.REVERSE_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                ReverseTntEntity tntEntity = new ReverseTntEntity(entityType, world);
