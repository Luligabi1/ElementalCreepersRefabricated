...
public class LightTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public LightTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.LIGHT_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                LightTntEntity tntEntity = new LightTntEntity(ElementalCreepers.LIGHT_TNT_ENTITY, world);
