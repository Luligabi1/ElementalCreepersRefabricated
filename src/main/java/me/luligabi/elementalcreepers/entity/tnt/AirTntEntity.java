...
public class AirTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public AirTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.AIR_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                AirTntEntity tntEntity = new AirTntEntity(ElementalCreepers.AIR_TNT_ENTITY, world);
    ...
    @Override
    public void explode() {
        new ExplosionEffects().airExplosionEffect(this.world, this.getX(), this.getY(), this.getZ());
    }
