...
public class IceTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public IceTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.ICE_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                IceTntEntity tntEntity = new IceTntEntity(ElementalCreepers.ICE_TNT_ENTITY, world);
