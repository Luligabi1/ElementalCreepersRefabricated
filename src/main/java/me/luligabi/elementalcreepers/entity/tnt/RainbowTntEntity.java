...
public class RainbowTntEntity extends ElementalTntEntity implements DispenserBehavior {
    ...
    public RainbowTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        ...
        DispenserBlock.registerBehavior(TntRegistry.RAINBOW_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                RainbowTntEntity tntEntity = new RainbowTntEntity(TntRegistry.RAINBOW_TNT_ENTITY, world);
