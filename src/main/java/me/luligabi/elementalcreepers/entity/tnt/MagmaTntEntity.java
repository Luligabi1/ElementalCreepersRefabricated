...
public class MagmaTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public MagmaTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.MAGMA_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                MagmaTntEntity tntEntity = new MagmaTntEntity(ElementalCreepers.MAGMA_TNT_ENTITY, world);
