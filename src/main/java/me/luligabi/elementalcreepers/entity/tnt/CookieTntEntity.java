...
public class CookieTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public CookieTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.COOKIE_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                CookieTntEntity tntEntity = new CookieTntEntity(ElementalCreepers.COOKIE_TNT_ENTITY, world);
