...
public class FireworkTntEntity extends ElementalTntEntity implements DispenserBehavior {

    public FireworkTntEntity(EntityType<? extends ElementalTntEntity> entityType, World world) {
        super(entityType, world);

        DispenserBlock.registerBehavior(ElementalCreepers.FIREWORK_TNT_BLOCK, new ItemDispenserBehavior() {
            protected ItemStack dispenseSilently(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                FireworkTntEntity tntEntity = new FireworkTntEntity(ElementalCreepers.FIREWORK_TNT_ENTITY, world);
